...
import com.ajr.webapp.utils.Tools;
...
public class ContentServiceImpl implements IContentService {
	...
	public void publish(ContentVo contents) {
		...
		if (StringUtils.isNotBlank(contents.getSlug())) {
			...
			contentVoExample.createCriteria().andTypeEqualTo(contents.getType())
					.andStatusEqualTo(contents.getSlug());
	...
	@Override
	public PageInfo<ContentVo> getArticlesWithpage(ContentVoExample commentVoExample, Integer page,
			Integer limit) {
		PageHelper.startPage(page, limit);
