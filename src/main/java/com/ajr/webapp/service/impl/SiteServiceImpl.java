...
import com.ajr.webapp.controller.admin.AttachController;
import com.ajr.webapp.dao.AttachVoMapper;
import com.ajr.webapp.dao.CommentVoMapper;
import com.ajr.webapp.dao.ContentVoMapper;
import com.ajr.webapp.dao.MetaVoMapper;
...
import com.ajr.webapp.modal.Vo.*;
...
import com.ajr.webapp.utils.ZipUtils;
import com.ajr.webapp.utils.backup.Backup;
...
public class SiteServiceImpl implements ISiteService {
	...
	public BackResponseBo backup(String bk_type, String bk_path, String fmt) throws Exception {
		...
		if (bk_type.equals("attach")) {
			...
			String fname = DateKit.dateFormat(new Date(), fmt) + "_" + TaleUtils.getRandomNumber(5)
					+ ".zip";
